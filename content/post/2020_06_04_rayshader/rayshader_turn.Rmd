...
map_dfr(seq, function(hour_dec){
  ...
  # head(1) %>%
  pmap(function(elevation,azimuth,hour,minute,hour_dec){
    ...
    hill2 <- add_shadow(hillshade = hill, shadowmap = ray_shade(dem_mat,sunaltitude = elevation,sunangle = azimuth), max_darken = 0.5)
    ...
    render_snapshot(file.path(here_post,"turn2",paste0("hour_",hour_minute_fname,".png")),title_text = paste("Lake Zurich at",hour_minute_title))
    ...
    print(paste0(round(perc*100,2), "%. ETA: ",eta))
