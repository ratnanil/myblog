...
# raumtweets_folgen_smry <- raumtweets_folgen %>%
  # group_by(created_at,title_clean,date) %>% 
  # summarise_at(vars(favorite_count,retweet_count),max, na.rm = TRUE)
...
```{r}
ggplot(raumtweets_folgen, aes(favorite_count,retweet_count)) +
  geom_point() +
